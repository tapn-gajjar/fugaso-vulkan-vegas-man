...
export class BtnBetTable extends SlotButton {
    ...
    onDoAction() {
        ...
        AppG.emit.emit(CrashConst.EMIT_TABLE_TOGGLE, CrashConst.T_BET);
    }

    _toggle(state) {
        this._isActive = (state === CrashConst.T_BET && !this._isActive);
